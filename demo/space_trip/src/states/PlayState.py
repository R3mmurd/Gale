...
class PlayState(BaseState, InputListener):
    def enter(self) -> None:
        ...
        self.space = Space()
        self.flying_saucer = FlyingSaucer(settings.VIRTUAL_WIDTH // 2, settings.VIRTUAL_HEIGHT // 2)
        self.score = 0
    ...
    def update(self, dt: float) -> None:
        ...
        colling_stars_number = self.space.count_colliding_stars(self.flying_saucer.get_collision_rect())
    ...
    def render(self, surface: pygame.Surface) -> None:
        ...
        render_text(surface, f"score: {self.score}", settings.FONTS['stars'], 10, 10, (255, 255, 0))
