"""
gale (Game Architecture & Logic Engine): a collection of reusable
building blocks (state machines, input handling, physics, networking,
UI, AI, and more) to speed up building 2D games with pygame. Each
submodule (gale.state, gale.input_handler, gale.physics, gale.net,
gale.ui, gale.ai, ...) is independent — import only the ones a given
game actually needs.
