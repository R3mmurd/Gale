...
class AnimationTestCase(unittest.TestCase):
    ...
    def test_change_frame(self) -> None:
        ...
        self.assertEqual(2, self.infinite_animation.get_current_frame())
        self.limited_animation.update(0.2)
        self.assertEqual(5, self.limited_animation.get_current_frame())
    ...
    def test_loops(self) -> None:
        ...
        self.assertEqual(2, self.infinite_animation.get_current_frame())
        self.assertEqual(6, self.limited_animation.get_current_frame())
